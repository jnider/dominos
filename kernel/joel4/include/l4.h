...
/* CNode */
L4_CNode_Copy(L4_CNode service, L4_Word destIndex, uint8 destDepth, L4_CNode srcRoot, L4_Word srcIndex, uint8 srcDepth, L4_CapRights rights);
...
L4_CNode_Move(L4_CNode service, L4_Word destIndex, uint8 destDepth, L4_CNode srcRoot, L4_Word srcIndex, uint8 srcDepth);
